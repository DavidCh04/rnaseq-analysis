...
## Dataset
The RNA-seq data was obtained from a public GEO dataset. (Exact accession number to be added.)
...
**Overall design:** This RNA-seq dataset compares GLT-stimulated HK2 renal cells with and with sodium butirate versus untreated control.
