...
**Sample information**: A clean sample annotation table (samples.csv) was generated form the original SRA metadata and contains the run accesions an experimental conditions used in this analysis.
